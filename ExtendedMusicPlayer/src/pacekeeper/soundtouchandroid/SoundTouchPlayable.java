package pacekeeper.soundtouchandroid;

import static pacekeeper.soundtouchandroid.Constants.BUFFER_SIZE_TRACK;
import static pacekeeper.soundtouchandroid.Constants.DEFAULT_BYTES_PER_SAMPLE;
import static pacekeeper.soundtouchandroid.Constants.MAX_OUTPUT_BUFFER_SIZE;
...
public class SoundTouchPlayable implements Runnable
{
			...
			throws IOException
	{
		...
		Log.i("SoundTouchPlayable", "Created instance with file: " + fileName);
		return instance;
	}
