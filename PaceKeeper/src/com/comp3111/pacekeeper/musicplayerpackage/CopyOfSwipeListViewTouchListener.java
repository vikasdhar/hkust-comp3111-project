...
public class CopyOfSwipeListViewTouchListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link CopyOfSwipeListViewTouchListener} to inform its client
     ...
     */
    public CopyOfSwipeListViewTouchListener(ListView listView, OnSwipeCallback callback) {
     ...
     */
    public CopyOfSwipeListViewTouchListener(ListView listView, OnSwipeCallback callback, boolean dismissLeft, boolean dismissRight) {
     ...
     * {@link CopyOfSwipeListViewTouchListener} is paused during list view scrolling.</p>
     *
     * @see {@link CopyOfSwipeListViewTouchListener}
     */
